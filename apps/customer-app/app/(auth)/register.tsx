...
export default function RegisterScreen() {
  ...
  return (
    <Screen className="flex-1">
      ...
      <BrandMark />
      <Text className="text-ice text-3xl font-bold mt-8 mb-2">Create your account</Text>
      <Text className="text-mute mb-6">One bag across every shop in the mall.</Text>
      ...
      <Pressable className="mt-5" onPress={() => setShowPassword(true)}>
      ...
      <View className="mt-8 flex-row justify-center">
        <Text className="text-mute">Already shop here? </Text>
        <Link href="/(auth)/login">
          <Text className="text-glow font-semibold">Sign in</Text>
        </Link>
      </View>
      </ScrollView>
    </Screen>
