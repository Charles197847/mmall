  ...
  return (
    <View>
      ...
      <View className="px-4">
        ...
        >
          <View className="overflow-hidden bg-navy" style={{ borderRadius: 22 }}>
            <Image source={{ uri: productImage(product.images?.[0]) }} className="w-full" style={{ height: layout.heroProduct }} />
          </View>
          <Text className="text-ice mt-3" numberOfLines={2} style={{ fontSize: 22, lineHeight: 26, fontWeight: '300' }}>
            {product.name}
          </Text>
